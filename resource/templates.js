...
'<img src="../images/item-blue.png" class="bg-item">' +
'<div class="bottom"><img src="{imgsrc}"></div>' +
'<img class="description" src="images/description.png"><div class="name-application"><span>{title}</span></div></li>';
